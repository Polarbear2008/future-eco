-- SQL commands to set up the volunteers table and RLS policies
-- Run these in the Supabase SQL Editor

-- First, create the volunteers table if it doesn't exist
...
DROP POLICY IF EXISTS "Allow authenticated update and delete" ON volunteers;
